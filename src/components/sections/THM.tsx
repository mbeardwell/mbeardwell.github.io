...
export default function THM(): JSX.Element {
	...
	return (
		<BorderedCard className="flex items-center justify-center leading-tight">
			{stats ? (
				<div className="flex flex-row gap-4 p-3 text-content text-md">
					<div className="flex flex-col justify-center flex-grow">
						...
						<div>
							...
							<span className="font-semibold">
								{stats.completedRoomsNumber} (100+ hrs)
							</span>
						</div>
					</div>
