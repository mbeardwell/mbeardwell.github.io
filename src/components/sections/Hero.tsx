	...
	return (
		...
		>
			...
			>
				...
				<div
					...
					style={{
						...
						boxShadow:
							"0 0 0 10px color-mix(in srgb, var(--ac) 7%, transparent), 0 0 80px color-mix(in srgb, var(--ac) 14%, transparent)",
					}}
				>
					<img
				...
				<div className="flex-1 text-right max-md:text-center">
					...
					<div className="flex justify-end max-md:justify-center mb-7">
						<div
							className="w-16 h-px"
							style={{
								background: "linear-gradient(to left, var(--ac), transparent)",
							}}
						/>
					</div>
					...
					<div className="flex flex-col items-end max-md:items-center gap-2">
						...
						<div className="hidden md:flex items-center">
							...
							<span className="text-[rgba(245,248,254,0.15)] px-5 select-none text-sm">
								|
							</span>
							<HeroLink
								label="LinkedIn"
			...
			<div
				...
				aria-hidden
			>
				<span className="text-[9px] tracking-[0.18em] uppercase text-[var(--mu)]">
					Scroll
				</span>
				<div
