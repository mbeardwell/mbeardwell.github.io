		...
		<Section id="about">
			<div className="flex flex-col gap-10">
				...
				<div ref={r2} className="grid grid-cols-1 sm:grid-cols-3 gap-8">
					{[
						{
							val: stats?.topPercentage ?? 2,
							prefix: "Top ",
							suffix: "%",
							label: "Global Ranking — TryHackMe",
						},
						{
							val: stats?.completedRoomsNumber ?? 114,
							prefix: "",
							suffix: "",
							label: "Rooms completed (100+ hrs) — TryHackMe",
						},
						{
							val: 1,
							prefix: "",
							suffix: "st Class",
							label: "BSc Computer Science, KCL",
						},
						...
						<div key={label} className="border-t-2 border-accent pt-3">
							...
							<div className="text-[10px] tracking-[0.14em] uppercase text-[var(--mu)]">
								{label}
							</div>
						</div>
					))}
				...
				<div ref={r3} className="grid grid-cols-1 md:grid-cols-2 gap-16">
					...
					<div className="flex flex-col gap-4">
						<p className="text-[15px] leading-[1.8] text-[var(--mu)]">
						...
						<p className="text-[15px] leading-[1.8] text-[var(--mu)]">
							Forensics background spans lab-based and real-world recovery using
							Autopsy, dd, foremost, and photorec.
						</p>
						<p className="text-[15px] leading-[1.8] text-[var(--mu)]">
